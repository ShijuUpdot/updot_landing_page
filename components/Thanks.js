...
const Thanks = () => {
  return (
    <div className="flex flex-col justify-center items-center relative bg-white rounded-xl justify-self-center w-full md:max-w-md lg:max-w-lg  xl:max-w-xl ml-auto px-6 xl:px-12 md:px-8  drop-shadow-xl h-max">
      <Image
        src={ThanksImage}
        alt="thanks"
        width={300}
